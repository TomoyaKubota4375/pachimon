...
export const monstersAdditions = {
  ...
  shirokumamon: {
    id: "shirokumamon", name: "シロクマもん", type: TYPES.WHITE, imagePath: "/monsters/shirokumamon.png",
  ...
  komorimon: {
    id: "komorimon", name: "コウモリもん", type: TYPES.BLACK, imagePath: "/monsters/komorimon.png",
